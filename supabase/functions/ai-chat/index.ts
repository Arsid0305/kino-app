...
Правила:
- suggestions: ВСЕГДА РОВНО 2 фильма/сериала. Не 1, не 3 — именно 2. Никаких исключений. Даже для конкретного запроса — найди второй похожий. Оба фильма должны быть из РАЗНЫХ жанров.
